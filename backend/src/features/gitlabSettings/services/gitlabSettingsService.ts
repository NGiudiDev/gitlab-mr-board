...
import type { GitLabCredentials, GitLabSettingsService, GitLabSettingsServiceOptions, GitLabSettingsSummary, SaveGitLabSettingsInput, StoredGitLabSettings } from '../types.js';
