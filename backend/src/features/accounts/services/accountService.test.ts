...
interface TestContext {
  ...
  /** Da de alta un usuario en una cuenta, para contar miembros. */
  addMember: (accountId: string, username: string) => Promise<void>;
}
...
async function createContext(): Promise<TestContext> {
  ...
  return {
    ...
    addMember: async (accountId: string, username: string) => {
