...
- El respaldo de la base lo cubre Neon, con sus ramas y su recuperación por punto en el tiempo. Lo que sí hay que respaldar aparte es **`ENCRYPTION_KEY`**: sin ella, un volcado de la base no alcanza para recuperar los access token y cada persona tiene que cargar el suyo de nuevo.
